...
const TournamentRegistrations = () => {
  ...
  const handleDownloadPDF = async () => {
    ...
    try {
      ...
      doc.text(`Date: ${new Date(tournament.startDate).toLocaleDateString('en-GB', { day: 'numeric', month: 'long', year: 'numeric' })}, ${new Date(tournament.startDate).toLocaleDateString('en-GB', { weekday: 'long' })}`, 14, 34);
